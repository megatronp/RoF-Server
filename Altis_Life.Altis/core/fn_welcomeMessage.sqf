...
_role1 = "=RoF= and Shasta's Life Server"; //In yellow
_role1names = ["Welcome to the Reavers of Fate Altis Life roleplay community. A place for gamers, made by gamers"]; //In white
_role2 = "Use the Map!";
...
_role3 = "Server Rules";
_role3names = ["Please read the entire server rules here http://rof-gaming.enjin.com "];
_role4 = "Gang Zone";
_role4names = ["The Gang Zone aka Lawless area is just that. VDM, and RDM rules there do not apply "];
