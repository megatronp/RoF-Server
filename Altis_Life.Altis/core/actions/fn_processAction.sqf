...
_itemInfo = switch (_type) do
{
	...
	case "grapes": {["grapes","wine",250,(localize "STR_Process_Wine")]};
	case "moonshine": {["grapes","moonshine",450,(localize "STR_Process_Moonshine")]};
	case "uranium": {["uranium","euranium",2050,(localize "STR_Process_Uranium")]};
	default {[]};
};
