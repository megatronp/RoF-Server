...
if(playerSide == west) then {
	...
	if(_curTarget isKindOf "Ship") then {
		...
		if(typeOf (_curTarget) in ["C_Kart_01_Blu_F","C_Kart_01_Red_F","C_Kart_01_Fuel_F","C_Kart_01_Vrana_F"]) then {
			...
			_Btn6 buttonSetAction "life_vInact_curTarget setPos [getPos life_vInact_curTarget select 0, getPos life_vInact_curTarget select 1, (getPos life_vInact_curTarget select 2)+0.8]; closeDialog 0;";
	...
	if(_curTarget isKindOf "Ship") then {
		...
		if(typeOf (_curTarget) in ["C_Kart_01_Blu_F","C_Kart_01_Red_F","C_Kart_01_Fuel_F","C_Kart_01_Vrana_F"]) then {
			...
			_Btn2 buttonSetAction "life_vInact_curTarget setPos [getPos life_vInact_curTarget select 0, getPos life_vInact_curTarget select 1, (getPos life_vInact_curTarget select 2)+0.8]; closeDialog 0;";
	...
	if(!(player getVariable["restrainedCiv",false]) && !life_istazed) then {
		_Btn4 ctrlSetText localize "STR_vInAct_PullOut";
