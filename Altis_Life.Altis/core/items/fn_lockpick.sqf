...
if(_curTarget getVariable["purpose",""] == "truck_mission") exitWith { hint localize "STR_NOTF_TruckErr"; closeDialog 0; };
...
while {true} do
{
	...
	if((player getVariable["restrained",false]) OR (player getVariable["restrainedCiv",false])) exitWith {_ui = "osefStatusBar" call BIS_fnc_rscLayer;_ui cutRsc["osefStatusBar","PLAIN"];};
