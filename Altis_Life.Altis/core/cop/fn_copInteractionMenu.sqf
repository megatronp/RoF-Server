...
_Btn8 ctrlSetText localize "STR_pInAct_RemoveHeadgear";
_Btn8 buttonSetAction "[life_pInact_curTarget] call life_fnc_removeHeadgear; closeDialog 0;";
...
if(!((player distance (getMarkerPos "police_hq_1") < 40) OR  (player distance (getMarkerPos "police_hq_2") < 40) OR (player distance (getMarkerPos "cop_spawn_2") < 40) OR (player distance (getMarkerPos "cop_spawn_3") < 40) OR (player distance (getMarkerPos "cop_spawn_4") < 40) OR (player distance (getMarkerPos "cop_spawn_5") < 40) OR (player distance (getMarkerPos "cop_spawn_6") < 20))) then 
{
