[] spawn  {
	...
	_fnc_battery =
	{
		if(life_battery < 2) then {hint localize "STR_NOTF_PhoneMsg";}
		else
		{
			...
			{
				case 30: {hint localize "STR_NOTF_PhoneMSG_1";};
				case 20: {hint localize "STR_NOTF_PhoneMSG_2";};
				case 10: {hint localize "STR_NOTF_PhoneMSG_3";};
			};
		};
	};
