class DeathScreen
{
	...
	class Controls
	{
		...
		class RespawnBtn : Life_RscButtonMenu
		{
			...
			h = (1 / 25);
			text = "Respawn";
			onButtonClick = "closeDialog 0; life_is_arrested = false; [0,'!!!Death/Combat log and you will go to Jail!!!'] spawn life_fnc_broadcast; life_respawned = true; [] call life_fnc_spawnMenu;";
