class SettingsMenu
{
	...
	class controls
	{
		...
		class VD_terr_none : Life_RscActiveText
		{
			idc = -1;
			text = "None";
			action = "['none'] call life_fnc_onTerrainChange;";
			sizeEx = 0.04;
		...
		class VD_terr_low : Life_RscActiveText
		{
			idc = -1;
			text = "Low";
			action = "['low'] call life_fnc_onTerrainChange;";
			sizeEx = 0.04;
		...
		class VD_terr_normal : Life_RscActiveText
		{
			idc = -1;
			text = "Normal";
			action = "['norm'] call life_fnc_onTerrainChange;";
			sizeEx = 0.04;
		...
		class VD_terr_high : Life_RscActiveText
		{
			idc = -1;
			text = "High";
			action = "['high'] call life_fnc_onTerrainChange;";
			sizeEx = 0.04;
