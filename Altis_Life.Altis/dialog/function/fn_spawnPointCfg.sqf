...
switch (_side) do
{
	...
	case civilian:
	{
		...
		if ((getPlayerUID player) in ["Vil","76561198000929433","TikTak","76561198068283211","iahteapples","76561198078487246","Sparkz","76561198077565781","Doc Ock?","76561198090778600","Whosys","7656119796666310","Dread","76561198015470642","Shark Brayve","76561198056827304","Whoszy","76561197966663101","Fritx","76561198055220818"] OR license_civ_gang_ogc) then {
			_return set[count _return,["gang_spawn_1","Ocean Grown Crew Base","\a3\ui_f\data\map\MapControl\watertower_ca.paa"]];
		};
		if ((getPlayerUID player) in ["Stan","76561198003293878","MetalMan?","76561197989155354","Zako","76561198077234506","Jacob","76561198054590805","Howard Raider","76561197961249847","Kimble Commandos","76561197971066461","Tyler","76561198077414225","NothingIllegal","76561198080865189","Dresh","76561197995083296","Sharpey Stephen","76561198084468705","Ord Ulrich","76561198065459651"] OR license_civ_gang_boundurant) then {
			_return set[count _return,["gang_spawn_2","Bondurant Base","\a3\ui_f\data\map\MapControl\watertower_ca.paa"]];
		};
		if ((getPlayerUID player) in ["Erlien","76561198018478329","SgtCanadian","76561197990806511","Jager","76561197977646084","Kubi","76561197996330395","Adamz","76561198041954375"] OR license_civ_gang_enterprise) then {
			_return set[count _return,["gang_spawn_4"," The Enterprise Base","\a3\ui_f\data\map\MapControl\watertower_ca.paa"]];
		};
		if ((getPlayerUID player) in ["Brother DeadEye","76561198127515643","GENARK EMS","76561198071083862","BrotherBondWigglesBum","76561198162193930","Brother RDK MCPO ret.","76561198110731605","Brother Ninjapebble","76561198055760750","Brother Joe","76561198086642309","TBBTBAssas1n","76561198136849546","Denverken","76561197980969417"] OR license_civ_gang_tbb) then {
		...
		if (license_civ_gang_newscrew) then {
			_return set[count _return,["license_civ_gang_newscrew_spawn","Channel 7 Press Pass","\a3\ui_f\data\map\MapControl\watertower_ca.paa"]];
		};
		if (license_civ_gang_open1) then {
			_return set[count _return,["gang_spawn_3","Open Gang1","\a3\ui_f\data\map\MapControl\watertower_ca.paa"]];
		};
