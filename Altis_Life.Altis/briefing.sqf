...
// Police Section
	...
	player createDiaryRecord ["policerules",
		[
			"Raiding/Camping",
				...
				7. An area cannot be raided again for 45 minutes after a previous raid.<br/>
				8. If the raid is a failure (All officers die), the 45 minute timer still applies to those officers.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Teamspeak Rule",
				"
				1. All cops must be on Teamspeak 3@tsks1.vilayer.com:9988 in a designated cop channel. Failure to be on comms during an admin check can get you booted from the cops<br/>
	...
	player createDiaryRecord ["controls",
		[
			"",
				...
				Left Shift + B Zip ties a civilian,<br/>
				...
				Left Shift + H or CNTRL + H: Holsters a handgun<br/>
